...
export function useCardUtils() {
  const colorConfig: Record<string, {
    ...
    ironclad:    { label: 'The Ironclad',     apiValue: 'ironclad',    accent: 'text-red-400',     border: 'border-red-600',     bg: 'bg-red-950/20',      dot: 'bg-red-500',     glow: 'shadow-glow-red'    },
    silent:      { label: 'The Silent',       apiValue: 'silent',      accent: 'text-emerald-400', border: 'border-emerald-600', bg: 'bg-emerald-950/20',  dot: 'bg-emerald-500', glow: 'shadow-glow-green'  },
    defect:      { label: 'The Defect',       apiValue: 'defect',      accent: 'text-sky-400',     border: 'border-sky-600',     bg: 'bg-sky-950/20',      dot: 'bg-sky-500',     glow: 'shadow-glow-blue'   },
    necrobinder: { label: 'The Necroblinder', apiValue: 'necrobinder', accent: 'text-pink-400',    border: 'border-pink-600',    bg: 'bg-pink-950/20',     dot: 'bg-pink-500',    glow: 'shadow-glow-pink'   },
    regent:      { label: 'The Regent',       apiValue: 'regent',      accent: 'text-orange-400',  border: 'border-orange-600',  bg: 'bg-orange-950/20',   dot: 'bg-orange-500',  glow: 'shadow-glow-orange' },
    colorless:   { label: 'Colorless',        apiValue: 'colorless',   accent: 'text-slate-400',   border: 'border-slate-500',   bg: 'bg-slate-800/20',    dot: 'bg-slate-500',   glow: ''                   },
  }
