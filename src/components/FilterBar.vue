...
<template>
  <div class="rounded-lg p-4 space-y-4" style="background: var(--bg-surface); border: 1px solid var(--border);">
    ...
    <div class="relative">
      ...
      <input :value="store.filters.search" type="text" placeholder="Search cards…" class="input pl-9"
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-1.5">
        <button v-for="color in colorOrder" :key="color"
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-1.5">
        <button v-for="type in typeOrder" :key="type"
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-1.5">
        <button v-for="rarity in rarityOrder" :key="rarity"
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-1.5">
        <button v-for="kw in keywordOrder" :key="kw"
          class="px-2.5 py-1 rounded text-xs font-medium transition-all border"
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-1.5">
        <button v-for="opt in (['compendium','name','cost','type','rarity'] as const)" :key="opt"
